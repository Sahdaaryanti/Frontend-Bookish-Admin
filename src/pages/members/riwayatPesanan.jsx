...
// src/RiwayatPesanan.js
// import React from 'react';

const RiwayatPesanan = () => {
  // Data riwayat pesanan
  const riwayatPesanan = [
    { judul: 'Buku 1', jumlah: 2, totalHarga: 50 },
    { judul: 'Buku 2', jumlah: 1, totalHarga: 30 },
      ...
      <table className="min-w-full bg-white border border-gray-300">
        <thead>
          <tr>
            ...
            <th className="py-2 px-4 border-b">Jumlah Buku</th>
        ...
        <tbody>
          {riwayatPesanan.map((pesanan, index) => (
            <tr key={index}>
              <td className="py-2 px-4 border-b">{pesanan.judul}</td>
              <td className="py-2 px-4 border-b">{pesanan.jumlah}</td>
              <td className="py-2 px-4 border-b">{pesanan.totalHarga}</td>
            </tr>
          ))}
        </tbody>
      </table>
